        ...
        <>
          ...
          /> */}
                    ...
                    <div className="intro-text-2  text-lg tracking-wide leading-8	  flex-wrap font-normal text-white xl:pl-2 mt-3">
                        I have done my{" "}
                        <span className="bg-blue-600/30 px-2 py-1 mr-2 rounded-md ">
                            Bachelor of Engineering in Computer Engineering🎓
                        </span>
                        3⭐ CodeChef programmer, As a full-stack developer, I
                        specialize in the
                        <span className="bg-green-500/30 px-2 py-1 rounded-md ">
                            MERN (MongoDB,ExpressJS,ReactJS,NodeJS) Stack💻
                        </span>
                        and possess a deep understanding of React architecture,
                        Restful web services, and database design. My passion
                        lies in creating straightforward and elegant tools, and
                        I continuously challenge myself to expand my skill
                        {/* and a
